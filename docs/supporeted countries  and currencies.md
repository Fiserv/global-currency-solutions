...
| Currency Name (ISO 3166)               | Country(Alpha 3-Code) | Currency                     | Currency(Alpha 3-Code) | Minor Units | Region | DCC(1)  | MCP VI/MC | MCP AMEX(2) |  
|----------------------------------------|:----------------------|------------------------------|:-----------------------|:------------|:-------|:--------|:----------|:------------|
...
| American Samoa                         | ASM                   | United States Dollar         | USD                    | 2           | APAC   | USD(3)  | YES       | YES         |
