...
<br>4. Select <b><i> API Explorer > Exchange Rate </i></b> for  <a href="product/FXSolutions/api/?type=post&path=/fx/v1/pricing/request/allrates&branch=develop&version=1.0.0">Get All Rates </a> and Get Rate APIs used for Dynamic Currency Conversion and Multi-Currency Pricing.
